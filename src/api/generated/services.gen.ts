...
import type {
  DeleteApiUserFavouritesByRequestIdData,
  DeleteApiUserFavouritesByRequestIdError,
  DeleteApiUserFavouritesByRequestIdResponse,
  GetApiRequestByIdData,
  GetApiRequestByIdError,
  GetApiRequestByIdResponse,
  GetApiRequestError,
  GetApiRequestResponse,
  GetApiUserError,
  GetApiUserFavouritesError,
  GetApiUserFavouritesResponse,
  GetApiUserResponse,
  PostApiAuthData,
  PostApiAuthError,
  PostApiAuthResponse,
  PostApiRequestByIdContributionData,
  PostApiRequestByIdContributionError,
  PostApiRequestByIdContributionResponse,
  PostApiUserFavouritesData,
  PostApiUserFavouritesError,
  PostApiUserFavouritesResponse,
} from './types.gen';
 ...
 */
export const getApiUserFavourites = <ThrowOnError extends boolean = false>(
 ...
 */
export const postApiUserFavourites = <ThrowOnError extends boolean = false>(
  options: Options<PostApiUserFavouritesData, ThrowOnError>,
) => {
 ...
 */
export const deleteApiUserFavouritesByRequestId = <ThrowOnError extends boolean = false>(
  options: Options<DeleteApiUserFavouritesByRequestIdData, ThrowOnError>,
) => {
 ...
 */
export const postApiRequestByIdContribution = <ThrowOnError extends boolean = false>(
  options: Options<PostApiRequestByIdContributionData, ThrowOnError>,
) => {
 ...
 */
export const getApiRequestById = <ThrowOnError extends boolean = false>(
  options: Options<GetApiRequestByIdData, ThrowOnError>,
) => {
